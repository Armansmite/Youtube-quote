...
Requires: pip install pillow moviepy google-auth google-auth-oauthlib google-auth-httplib2 google-api-python-client
""" 
...
# ... (rest of the script exactly as provided, no changes) ...
# Make sure all functions and the main() call are included. 
...
# ----------------------------------------------------------------------
# YouTube authentication – manual console code (works without browser)
# ----------------------------------------------------------------------
...
            # Use a localhost redirect URI (deprecated OOB no longer works)
...
            print("Copy the FULL URL (or just the code after 'code=' up to '&scope') and paste it here.")
            code = input("Enter the code or the full redirect URL: ").strip()
            # If the user pasted the whole URL, extract the code part
            if "code=" in code:
