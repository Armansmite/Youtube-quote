...
def bot_process():
    # The bot logic – identical to what was previously written.
    # (Copy the full bot_process function from the earlier version here.)
    # For brevity I'm including a placeholder – replace with the real implementation.
    add_log("Bot process placeholder – replace with full code.")
    # (The full implementation should be exactly as in the earlier advanced V4 script.)
...
# ----------------------------------------------------------------------
# Bot process (replace with the full implementation)
# ----------------------------------------------------------------------
def bot_process():
    # (Insert the full bot_process code from the previous V4 answer here)
    pass
...
def start_ngrok():
    ngrok.kill()
    # YOUR AUTHTOKEN – keep it private!
