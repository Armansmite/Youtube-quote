...
# Suppress MoviePy syntax warnings and ALSA noise
...
# ----------------------------------------------------------------------
# YouTube authentication (now uses run_console for headless machines)
# ----------------------------------------------------------------------
def get_authenticated_service():
    ...
    if not credentials or not credentials.valid:
        if credentials and credentials.expired and credentials.refresh_token:
            ...
            # Use run_console() to work without a browser
...
def create_video(quote, writer, subject, image_path, music_path, output_video, output_thumb):
    ...
    final_video.write_videofile(
        ...
        remove_temp=True,
        verbose=False,
        logger=None,   # suppresses moviepy progress bars
    )
    final_video.close()
    audio_clip.close()
    img_clip.close()
