# =====================================================================
# YouTube Shorts Bot – Colab Worker (V4) – JSON Token Edition
# =====================================================================
...
def download_token():
    print("Downloading token from dashboard...")
...
# --- V1 helper functions (same as always) ---
def load_processed():
...
def main():
    ...
    try:
        ...
        if max_videos == 0: max_videos = None
