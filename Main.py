...
# ----------------------------------------------------------------------
# Suppress harmless ALSA/FFmpeg warnings in headless environments
# ----------------------------------------------------------------------
os.environ["SDL_AUDIODRIVER"] = "dummy"          # silences SDL audio errors
os.environ["ALSA_CARD"] = "dummy"                # may silence some ALSA errors
warnings.filterwarnings("ignore", category=SyntaxWarning)  # moviepy regex warnings
...
def get_authenticated_service():
    ...
    if not credentials or not credentials.valid:
        if credentials and credentials.expired and credentials.refresh_token:
            ...
            # Manual code exchange – no run_console, no browser needed on the server
