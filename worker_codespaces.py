...
# ---------- V1 HELPERS (identical to your Colab code) ----------
# (I'll include them all for completeness – you can copy from the latest Colab cell)
def load_processed():
...
def main():
    ...
    for line_idx, line, data in to_process:
        ...
        # Call the config's create_video function
        try:
