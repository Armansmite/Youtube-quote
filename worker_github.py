...
def main():
    ...
    # ‼️ THIS IS THE CRITICAL PART – read per‑config settings correctly
    ...
    # Debug: log what settings we received (you can remove this later)
    send_log(f"📊 Settings received: total_duration={total_duration}, fade_duration={fade_duration}, "
    ...
    for line_idx, line, data in to_process:
        ...
        # Call the config's create_video with the fetched values
        try:
